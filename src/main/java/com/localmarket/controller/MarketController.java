...
public class MarketController {
    ...
    public String traditionalMarketsByRegion(@RequestParam(required = false) String region, Model model) {
        System.out.println("컨트롤러에서 받은 지역: " + region);
        List<TraditionalMarketDto> traditionalMarkets;
        ...
        return "markets/traditional-region";
    }
